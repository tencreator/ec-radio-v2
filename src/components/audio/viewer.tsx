    ...
    return (
        <>
            <section className="w-full flex justify-center fixed bottom-0 mb-2">
                <div className="flex flex-col md:flex-row bg-base-200 rounded-md border-solid border-base-300 border-2 items-center md:w-9/12 lg:w-8/12 xl:w-6/12 overflow-hidden py-1">
