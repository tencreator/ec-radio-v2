...
export default function Viewer(): JSX.Element {
    ...
    return (
        <>
            <section className={"z-50 w-11/12 md:w-9/12 lg:w-8/12 xl:w-6/12 mx-auto flex fixed bottom-0 mb-2 transition-all self-center " + (show ? 'justify-center' : 'justify-end pr-4')}>
                {show ? (
