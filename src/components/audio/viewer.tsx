    ...
    return (
        <>
            <section className={"w-full flex fixed bottom-0 mb-2 transition-all " + (show ? 'justify-center' : 'justify-end pr-4')}>
                {show ? (
                    <div className="z-50 flex flex-col md:flex-row items-center w-11/12 md:w-9/12 lg:w-8/12 xl:w-6/12 overflow-hidden py-1 rounded-md border-solid border-2 bg-zinc-700 border-zinc-500">
                    ...
                    <div className="z-50 flex flex-col md:flex-row items-center overflow-hidden p-1 rounded-md border-solid border-2 bg-zinc-700 border-zinc-500">
                        <button className="btn btn-ghost flex items-center justify-center" onClick={()=>setShow(!show)}>
                            <i className={(show ? 'fa-chevron-right' : 'fa-chevron-left')+' fa-solid'}></i>
                        </button>
                    </div>
