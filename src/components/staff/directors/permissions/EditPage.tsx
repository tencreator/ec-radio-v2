...
export default function EditPerm({id, roleid,  currentPerms}: {id: string, roleid: string, currentPerms: string[]}) {
    const router = useRouter()
    const [role, setRole] = useState<string>(roleid)
...
function PermCategory({title, nodes, perms, updatePerms}: {title: string, nodes: {label: string, perm: Permissions}[], perms: string[], updatePerms: (perm: Permissions) => void}) {
    return (
        <div className="flex flex-col">
