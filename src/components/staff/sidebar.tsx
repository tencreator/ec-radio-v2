...
export default function Sidebar({perms}: {perms: string[]}) {
    ...
    return (
        <div className='min-h-full'>
            <button ref={sidebarToggleRef} className='btn bg-slate-800 border border-solid border-gray-500 fixed top-20 right-5 text-2xl md:hidden' onClick={()=>setShow(!show)}>
